...
<?php 
	...
	/*判断数据库中有多少条记录*/
	$sql = "select userId from userLoc_info";
	$query = $mysqli->query($sql);
	$l = $query->num_rows;
	//$mysqli->query("delete from userLoc_info");
	...
	/*开始从文件里读取数据并写入数据库*/
	$i = ($l+1);
	$fp = fopen("../userLocInfo.txt","r") or exit("文件无法打开");
...
//			echo $id."<br/>".$userInfo."\n";
			$insert_sql = "insert into userLoc_info (userId ,userLocInfo) values('$id','$userInfo')";
